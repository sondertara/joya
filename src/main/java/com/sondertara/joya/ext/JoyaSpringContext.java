...
public class JoyaSpringContext implements ApplicationContextAware {
  ...
  public static <T> T registerBean(String name, Class<T> clazz, Object... args) {
    Assert.isTrue(
        getApplicationContext() instanceof ConfigurableApplicationContext,
   ...
   *
   * <p>if the config is not exist will return the default value
   *
   * @param key key
  ...
  public static Boolean getConfig(String key, Boolean defaultValue) {
    ...
    return Boolean.valueOf(
        getApplicationContext().getEnvironment().getProperty(key, String.valueOf(defaultValue)));
  }
