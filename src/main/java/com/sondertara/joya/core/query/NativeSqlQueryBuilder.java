...
public class NativeSqlQueryBuilder implements SelectBuilder, FromBuilder, WhereBuilder {
  ...
  /**
   * 查询表的全部列,对于联表查询 如果字段名字有重复,只保留前面一个字段,可以配置 {@link NativeSqlQueryBuilder#wrapColumn(String...)}
   * ()}wrapColumn来指定字段别名
   */
  @Override
  ...
  public <T1, T2> FromBuilder select(TaraFunction<T1, ?> f1, TaraFunction<T2, ?> f2) {
    StringJoiner sj = new StringJoiner(", ");
    this.select =
        sj.add(AliasThreadLocalCache.getColumn(f1).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f2).getColumnAlias())
            .toString();
    return this;
  }

  @Override
  public <T1, T2, T3> FromBuilder select(
      TaraFunction<T1, ?> f1, TaraFunction<T2, ?> f2, TaraFunction<T3, ?> f3) {
    StringJoiner sj = new StringJoiner(", ");
    this.select =
        sj.add(AliasThreadLocalCache.getColumn(f1).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f2).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f3).getColumnAlias())
            .toString();
    return this;
  }

  @Override
  public <T1, T2, T3, T4> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4) {
  ...
  @Override
  public <T1, T2, T3, T4, T5> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
    ...
    this.select =
        sj.add(AliasThreadLocalCache.getColumn(f1).getColumnAlias())
            ...
            .add(AliasThreadLocalCache.getColumn(f3).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f4).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f5).getColumnAlias())
            .toString();
    return this;
  }

  @Override
  public <T1, T2, T3, T4, T5, T6> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
    ...
    this.select =
        sj.add(AliasThreadLocalCache.getColumn(f1).getColumnAlias())
            ...
            .add(AliasThreadLocalCache.getColumn(f4).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f5).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f6).getColumnAlias())
            .toString();
    return this;
  }

  @Override
  public <T1, T2, T3, T4, T5, T6, T7> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
  ...
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
    ...
    this.select =
        sj.add(AliasThreadLocalCache.getColumn(f1).getColumnAlias())
            ...
            .add(AliasThreadLocalCache.getColumn(f6).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f7).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f8).getColumnAlias())
            .toString();
    return this;
  }

  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
    ...
    this.select =
        sj.add(AliasThreadLocalCache.getColumn(f1).getColumnAlias())
            ...
            .add(AliasThreadLocalCache.getColumn(f7).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f8).getColumnAlias())
            .add(AliasThreadLocalCache.getColumn(f9).getColumnAlias())
            .toString();
    return this;
  }

  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
  ...
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
  ...
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromBuilder select(
      TaraFunction<T1, ?> f1,
      TaraFunction<T2, ?> f2,
      TaraFunction<T3, ?> f3,
      TaraFunction<T4, ?> f4,
      ...
      for (String s1 : split) {
        ...
        if (s1.contains("join")) {
          throw new TaraException(
              "Table join is not allowed here,please use [from(Class<?>... clazz)] or [from(UnaryOperator<JoinCriterion> func)].");
        }
        // 有别名的情况
        if (s1.contains(" ") || StringUtils.containsIgnoreCase(s1, "AS")) {
          throw new TaraException(
              "The table alias name will generate by default,so don`t allocate the alias");
        }
        sj.add(s1);
  ...
  /** where 使用方式: nativeSql.where(w -> w.eq().ne().in()) */
  @Override
  ...
  /** having 使用方式: nativeSql.having(h -> h.eq().ne().in()) */
  @Override
  ...
  /**
   * orderBy 排序参数如果是前端传进来,用QueryRequest接收的 ===> nativeSql.orderBy( queryRequest.getOrderBy(表别名) )
    ...
    if (StringUtils.isBlank(this.from) && null != joinCriterion) {
      ...
      if (!nodeList.isEmpty()) {
        ...
        if (nodeList.getSize() > JoyaConst.TWO_QUERY_COUNT) {
          ...
          if (forth.getTableName().equals(first.getTableName())
              || forth.getTableName().equals(second.getTableName())) {
    ...
    if (SELECT_ALL.equals(select)) {
      ...
      for (TableAlias table : tables) {
        ...
        for (Map.Entry<String, String> entity : fields.entrySet()) {
          ...
          if (null != map) {
            String s1 =
                fieldName.equals(StringUtils.toCamelCase(columnName))
                    ? StringFormatter.format("{}.{}", table.getAliasName(), columnName)
                    : StringFormatter.format(
                        "{}.{} AS {} ", table.getAliasName(), columnName, fieldName);
  ...
  private void buildForm(StringJoiner sj, List<TableAlias> tables) {
    ...
    if (StringUtils.isNotBlank(from)) {
      ...
      for (TableAlias table : tables) {
        ...
        stringJoiner.add(
            StringFormatter.format("{} {}", table.getTableName(), table.getAliasName()));
      }
