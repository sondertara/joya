...
//                        }
     ...
     */
    public static <
            T> ResultDTO<T> get(String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) {
        log.info("restFul get请求开始 url={},params={},responseType={}", url, params, responseType);
        try {
            url = buildUrl(url, params);
            HttpEntity httpEntity = buildHttpEntity(params, buildHeaders(headers));
     ...
     */
    public static <
            T> ResultDTO<T> post(String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) {
     ...
     * @return 请求结果
     */
    public static <T> ResultDTO<T> put(String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) throws
            Exception {
     ...
     * @return 请求结果
     */
    public static <T> ResultDTO postXml(String url, String data, Class<T> responseType) {
    ...
    private static HttpEntity buildHttpEntity(Map<String, Object> params, HttpHeaders headers) {
    ...
    private static ResultDTO handleFailResult(HttpStatusCodeException e) {
