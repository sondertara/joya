...
public class RestTemplateUtils {
   ...
   * @return 响应结果
   */
  public static <T> ResultDTO<T> get(
      String url, Map<String, Object> params, Class<T> responseType) {
    return get(url, params, responseType, null);
  }

  public static <T> ResultDTO<T> get(
      String url, Map<String, Object> params, ParameterizedTypeReference<T> responseType) {
    return get(url, params, responseType, null);
  }
   ...
   * @return 响应结果
   */
  public static <T> ResultDTO<T> post(
      String url, Map<String, Object> params, Class<T> responseType) {
  ...
  public static <T> ResultDTO<T> get(
      String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) {
    ...
    try {
      ...
      ResponseEntity<T> responseEntity =
          RestTemplateUtils.getInstance().exchange(url, HttpMethod.GET, httpEntity, responseType);
      T result = responseEntity.getBody();
      if (Boolean.TRUE.equals(ThreadLocalUtil.get(DISABLE_PRINT_CACHE_KEY))) {
        log.info(
            "RESTful get请求结束 url=[{}],cost time=[{}],params=[{}]",
            url,
            System.currentTimeMillis() - start,
            params);
      } else {
        log.info(
            "RESTful get请求结束 url=[{}],cost time=[{}],params=[{}],responseType=[{}],result=[{}]",
            url,
            System.currentTimeMillis() - start,
            params,
            responseType,
      ...
      log.error(
          "RESTful get请求失败 url=[{}],params=[{}],responseType=[{}],errMsg:{}",
          url,
          params,
          responseType,
          e.getMessage());
  ...
  public static <T> ResultDTO<T> post(
      String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) {
    log.info(
        "RESTful post请求开始 url=[{}],params=[{}],responseType=[{}]",
        url,
    ...
    try {
      ...
      if (Boolean.TRUE.equals(ThreadLocalUtil.get(DISABLE_PRINT_CACHE_KEY))) {
        log.info(
            "RESTful post请求结束 url=[{}],cost time=[{}],params=[{}]",
            url,
            end - start,
            JSON.toJSONString(params));
      } else {
        log.info(
            "RESTful post请求结束 url=[{}],cost time=[{}],params=[{}],responseType=[{}],result=[{}]",
            url,
            end - start,
            JSON.toJSONString(params),
            responseType,
      ...
      log.error(
          "RESTful post请求失败 url=[{}],params=[{}],responseType=[{}],errMsg:{}",
          url,
          params,
          responseType,
          e.getMessage());
   ...
   */
  public static <T> ResultDTO<T> post(
      String url, String json, Class<T> responseType, Map<String, String> headers) {
   ...
   */
  public static <T> ResultDTO<T> post(
      String url, String json, ParameterizedTypeReference<T> responseType) {
  ...
  public static <T> ResultDTO<T> post(
    ...
    try {
      ...
      ResponseEntity<T> response =
          RestTemplateUtils.getInstance().exchange(url, HttpMethod.POST, httpEntity, responseType);
   ...
   * @return 请求结果
   */
  public static <T> ResultDTO<T> put(
      String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) {
    ...
    try {
      ...
      ResponseEntity<T> exchange =
          RestTemplateUtils.getInstance().exchange(url, HttpMethod.PUT, httpEntity, responseType);
      T result = exchange.getBody();
      long end = System.currentTimeMillis();
      log.info(
          "RESTful put请求结束 url=[{}],cost time=[{}],params=[{}],responseType=[{}],exchange=[{}]",
          url,
          end - start,
          params,
          responseType,
      ...
      log.error(
          "RESTful put请求失败 url=[{}],params=[{}],responseType=[{}],errMsg:{}",
          url,
          params,
          responseType,
          e.getMessage());
   ...
   * @return 请求结果
   */
  public static <T> ResultDTO<T> delete(
      String url, Map<String, Object> params, Class<T> responseType, Map<String, String> headers) {
    log.info(
        "RESTful delete请求开始 url=[{}],params=[{}],responseType=[{}]", url, params, responseType);
    long start = System.currentTimeMillis();
    try {
      url = buildUrl(url, params);
      HttpEntity<Map<String, Object>> httpEntity = buildHttpEntity(params, buildHeaders(headers));
      ResponseEntity<T> exchange =
          RestTemplateUtils.getInstance()
              .exchange(url, HttpMethod.DELETE, httpEntity, responseType, params);
      T result = exchange.getBody();
      log.debug(
          "RESTful delete请求结束 url=[{}],cost time=[{}],params=[{}],responseType=[{}],exchange=[{}]",
          url,
          System.currentTimeMillis() - start,
          params,
          responseType,
      ...
      log.error(
          "RESTful delete请求失败 url=[{}],params=[{}],responseType=[{}],errMsg:{}",
          url,
          params,
          responseType,
          e.getMessage());
  ...
  public static <T> ResultDTO<T> postXml(String url, String data, Class<T> responseType) {
    ...
    try {
      ...
      T result = RestTemplateUtils.getInstance().postForObject(url, httpEntity, responseType);
      log.info(
          "RESTful postXml请求结束 url=[{}],cost time=[{}],params=[{}],responseType=[{}],result=[{}]",
          url,
          System.currentTimeMillis() - start,
          data,
          responseType,
      ...
      log.error(
          "RESTful post xml 请求失败 url=[{}],data=[{}],responseType=[{}],errMsg:{}",
          url,
          data,
          responseType,
          e.getMessage());
  ...
  public static <T> ResultDTO<T> postXml(
      String url, String data, ParameterizedTypeReference<T> responseType) {
    log.info("RESTful post xml 请求开始 url=[{}],data=[{}],responseType=[{}]", url, data, responseType);
    long start = System.currentTimeMillis();
    try {
      HttpHeaders headers = new HttpHeaders();
