 ...
 *
 * <p>It will inject the joyaRepository and joyaSpringContext {@link JoyaSpringContext}which is a
 * SpringContext util
 *
 * @author huangxiaohu
 ...
 * @since 1.0.1
 */
public class JoyaRepositoryFactoryBean extends AbstractFactoryBean<JoyaRepository>
    ...
    if (applicationContext.containsBean(CONTEXT_HOLDER)) {
      ...
      if (bean.getClass().isAssignableFrom(JoyaSpringContext.class)) {
        ...
        throw new RuntimeException(
            StringFormatter.format("The bean name of '{}' is duplicated", CONTEXT_HOLDER));
      }
    }
    BeanDefinitionBuilder beanDefinitionBuilder =
        BeanDefinitionBuilder.genericBeanDefinition(JoyaSpringContext.class);
